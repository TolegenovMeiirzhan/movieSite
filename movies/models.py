...
class Movie(models.Model):
    ...
    budget = models.PositiveIntegerField("Budget", default=0, help_text="In dollors")
    fees_in_usa = models.PositiveIntegerField(
        "Fees in usa", default=0, help_text="In dollors"
    )
    fess_in_world = models.PositiveIntegerField(
        "Fees_in_world", default=0, help_text="In dollors"
    )
